...
void MX_FREERTOS_Init(void) {
  ...
  ScreenRefreshHandle = osThreadNew(StartScreenRefreshTask, NULL, &ScreenRefresh_attributes);
...
/* USER CODE BEGIN Header_StartScreenRefreshTask */
/**
...
void StartScreenRefreshTask(void *argument)
{
